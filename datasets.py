"""dataset class to provide __getitem__ method for dataloader"""
import numpy as np
...
class SiameseMNIST(Dataset):
    ...
    def __init__(self, mnist_dataset):
        ...
        if self.train:
            ...
            # generate test samples set
            self.test_pairs = positive_pairs + negative_pairs

    def __getitem__(self, index):
        if self.train:
            target = np.random.randint(0, 2) # 0 indicates nagative pairs, 1 indicates positive pairs
...
class TripletMNIST(Dataset):
    ...
    def __getitem__(self, index):
        if self.train:
            ...
            img3 = self.train_data[random_state.choice(self.label_to_indices[
                random_state.choice(self.labels_set - set([label1]))
                                                       ])]
        else:
